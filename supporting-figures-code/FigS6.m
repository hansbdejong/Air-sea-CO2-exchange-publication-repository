% plots the maps for Figure S6, FCO2

% load data

cd('C:\month_fco2')

Nov = xlsread('Nov_FCO2_W14_v3.xlsx');
Dec = xlsread('Dec_FCO2_W14_v3.xlsx');
Jan = xlsread('Jan_FCO2_W14_v3.xlsx');
Feb = xlsread('Feb_FCO2_W14_v3.xlsx');
Mar = xlsread('Mar_FCO2_W14_v3.xlsx');
mask = xlsread('shelf_mask_v2');
...
h = colorbar;
set(gca, 'CLim', [-80 20], 'fontsize', 15);
c = jet(25);
colormap(c(1:20,:));
